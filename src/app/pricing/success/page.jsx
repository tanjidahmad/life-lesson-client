...
<div className="mb-6 rounded-xl border border-amber-500/20 bg-amber-500/10 p-4">
    ...
    <p className="mt-2 text-xs text-zinc-400">
        Please login again to refresh your session and access your updated Premium plan.
    </p>
</div>
                    ...
                    <div className="space-y-3">
                        <Link
        href="/login"
        className="block w-full text-center text-xs font-semibold px-4 py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl shadow-lg transition duration-200"
    >
        Continue to Login
    </Link>
                    </div>
