...
// if (loading) {
// return ( <div className="flex h-[400px] items-center justify-center text-white">
// Loading... </div>
// );
// }

// return ( <div className="mx-auto max-w-4xl"> <div className="rounded-3xl border border-zinc-800 bg-zinc-900 p-8"> <h1 className="mb-8 text-3xl font-bold text-white">
// Update Lesson </h1>
